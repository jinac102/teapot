                     ...
                     <input type="hidden" name="eid" value="<?php echo $eno;?>">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <div class="select_wrap">
                                <select name="cc_idx" id="cc_idx" class="suit_rg_m type" value="1">
                                    <option>선택하기</option>
                                    <?php
                                        foreach($rsc as $r){
                                    ?>
                                    <option value="<?php echo $r->cc_idx?>" <?php if($row['cc_idx']==$r->cc_idx){echo "selected='selected'";}?>><?php echo $r->cc_name?></option>
                                    <?php }?>
                                </select>
